<div class="h-screen md:h-auto mt-2 md:mt-16 flex flex-col items-center text-center md:flex-row md:justify-between" id="hero">
    <div class="grid grid-rows-1 gap-8">
        ...
        <ul class="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-3 font-semibold">
