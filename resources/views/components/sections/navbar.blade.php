<nav class="flex items-center justify-between py-4 shadow-md rounded-2xl">
    ...
    <!-- Menu -->
    <ul id="menu" class="hidden lg:flex items-center gap-6 text-base-content">
        <li>
            <a href="{{ url('/') }}" class="relative transition duration-300 after:block after:h-1 after:bg-pink-500 after:w-0 after:transition-all after:duration-300 hover:after:w-full">
                Home
            </a>
        </li>
        <li>
            <a href="{{ url('/service') }}" class="relative transition duration-300 after:block after:h-1 after:bg-pink-500 after:w-0 after:transition-all after:duration-300 hover:after:w-full">
                Make an appointment
            </a>
        </li>
        <li>
...
<!-- Menu mobile -->
<div id="mobile-menu" class=" z-10 hidden lg:hidden bg-base-content shadow-md absolute top-22 left-0 w-full">
